...
export interface ApiHrToolkitHrToolkit extends Struct.CollectionTypeSchema {
  collectionName: 'hr_toolkits';
  info: {
    displayName: 'HR-Toolkit';
    pluralName: 'hr-toolkits';
    singularName: 'hr-toolkit';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiModuleModule extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    featureList: Schema.Attribute.Component<'home.block-one', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    module_count: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    tags: Schema.Attribute.Component<'shared.text-block', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userStories: Schema.Attribute.Component<'home.block-two', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::hr-toolkit.hr-toolkit': ApiHrToolkitHrToolkit;
